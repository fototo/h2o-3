...
public class GLMModel extends Model<GLMModel,GLMModel.GLMParameters,GLMModel.GLMOutput> {
  ...
  public static class GLMParameters extends Model.Parameters {
    static final String[] CHECKPOINT_NON_MODIFIABLE_FIELDS = {"_response_column", "_family", "_solver", "_alpha", 
            "_lambda", "_lambda_search", "_nlambdas", "_standardize", "_intercept", "_link", "_interactions",
            "_interaction_pairs"};
